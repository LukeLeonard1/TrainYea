...
public class CTATrainCar {
	...
	public CTATrainCar() {//default
		

	}
	
	public CTATrainCar(int NewCarID, int NewAmountOfCars, String NewLine, String NewDirection) {
		carID=NewCarID;
	...
	public String toString() {
		return carID + " " + direction + " " + currentCart + " " +seatRange();
